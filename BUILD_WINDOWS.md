...
Windows Defender or other antivirus may flag the executable. This is common with PyInstaller builds:

1. **Add exception** in Windows Security for `SpchToText_Recorder.exe`
2. Or **rebuild with code signing** (requires certificate)
